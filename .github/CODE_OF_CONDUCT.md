...
We — the Beelogik team and the community around our product **Beep** — pledge
to make our community welcoming, safe, and equitable for all.
...
possible violation, email **contact@beelogik.com**. All reports are received by
the Beelogik maintainers and are kept confidential.
...
an individual is officially representing **Beelogik** or the **Beep** project in
public or other spaces. Examples of representing our community include using an
official Beelogik email address, posting via an official Beelogik or Beep social
